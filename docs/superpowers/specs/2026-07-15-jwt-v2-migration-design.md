...
| `PATCH /api/v1/admin/popup-submissions/{submissionId}/status` | `V2_TWIN` | `PATCH /api/v2/admin/popup-submissions/{submissionId}/status` | `ADMIN` | `SUBMISSION_ID_AND_REJECTED_STATUS` | `ADMIN` | `CALLER_ADMIN_UUID_REMOVED_AND_APPROVAL_MOVED_TO_PUT` | `ADMIN` | `COMPLETE` | `NOT_STARTED` | `UNVERIFIED` | `NO_ROUTE_DATA` | `NO` |

...
public class QaApiKeyAuthenticationFilter extends OncePerRequestFilter {

  static final String HEADER_NAME = "X-QA-Api-Key";
  static final String QA_TOKEN_ISSUER = "QA_TOKEN_ISSUER";
  ...
  protected void doFilterInternal(
    ...
    if (!matches(providedApiKey)) {
      ...
      ApiAuthenticationEntryPoint.setError(request, ErrorCode.INVALID_QA_API_KEY);
    ...
    UsernamePasswordAuthenticationToken authentication =
        new UsernamePasswordAuthenticationToken(
            "qa-token-issuer", null, List.of(new SimpleGrantedAuthority(QA_TOKEN_ISSUER)));
